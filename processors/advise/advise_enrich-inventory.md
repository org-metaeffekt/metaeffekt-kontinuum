...
| param.assessment.dirs            | yes      | A comma seperated list of all directories or files containing assessments.                     |
| param.context.dirs               | yes      | A comma seperated list of all directories or files containing contexts.                        |
