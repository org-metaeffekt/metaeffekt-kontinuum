...
| output.notification.file      | no       | The name of the output notification file.                          | 
...
| param.notification.config.file   | no       | The configuration file for notification.                                          |
| param.notification.rule.file     | no       | The rule file for notification.                                                   |
