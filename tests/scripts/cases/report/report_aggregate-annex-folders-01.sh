...
export INPUT_INVENTORY_FILE="$EXTERNAL_WORKBENCH_DIR/inventories/example-reference-inventory/inventory/artifact-inventory.xls"
...
export PARAM_TARGET_COMPONENT_DIR=$TESTS_DIR/target/workspace-001/sample-product-1.0.0/08_reported/components"
