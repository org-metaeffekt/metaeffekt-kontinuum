...
export INPUT_POM_FILE="$WORKSPACE_002_DIR/sample-product-1.0.0/01_prepared/example-pom.xml"
export OUTPUT_INVENTORY_FILE="$EXTRACTED_DIR_002/example-pom-extracted.xlsx"
