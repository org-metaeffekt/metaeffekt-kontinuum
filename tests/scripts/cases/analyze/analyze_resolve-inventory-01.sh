...
export ARTIFACT_RESOLVER_CONFIG="$GENERIC_RESOURCES_DIR/artifact-resolver-config.yaml"
export PROXY_CONFIG="$GENERIC_RESOURCES_DIR/artifact-resolver-proxy.yaml"